            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-auto pl-0">
                        ...
                        <a href="index-2.html" class="logo"><img src="<?php echo base_url() . "templates/"; ?>img/logo-icon.png" alt=""><span class="text-hide-xs"><b>Go</b>TRI</span></a>
                    ...
                    <div class="col-auto pr-0">
                        ...
                        <div class="dropdown d-inline-block">
                            <a class="btn header-color-secondary btn-icon dropdown-toggle caret-none" href="#" role="button" id="dropdownmessage2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <figure class="avatar avatar-24 vm d-inline-block border"><img src="<?php echo base_url() . "templates/"; ?>img/india.png" alt=""></figure>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownmessage2">
                                <div class="dropdown-item">
                                    <figure class="avatar avatar-24 mr-2 vm d-inline-block"><img src="<?php echo base_url() . "templates/"; ?>img/india.png" alt=""></figure> India
                                </div>
                                <div class="dropdown-item">
                                    <figure class="avatar avatar-24 mr-2 vm d-inline-block"><img src="<?php echo base_url() . "templates/"; ?>img/canada.png" alt=""></figure> Canada
                                </div>
                                <div class="dropdown-item">
                                    <figure class="avatar avatar-24 mr-2 vm d-inline-block"><img src="<?php echo base_url() . "templates/"; ?>img/unitedstates.png" alt=""></figure> United States
                                </div>
                                <div class="dropdown-item">
                                    <figure class="avatar avatar-24 mr-2 vm d-inline-block"><img src="<?php echo base_url() . "templates/"; ?>img/uk.png" alt=""></figure> United Kingdom
                                </div>
                                <div class="dropdown-item">
                                    <figure class="avatar avatar-24 mr-2 vm d-inline-block"><img src="<?php echo base_url() . "templates/"; ?>img/china.png" alt=""></figure> China
                                </div>
                            </div>
                        </div>
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu notification-dropdown align-center arrow-top pt-0" aria-labelledby="dropdownmessage">
                                ...
                                <div class="media new">
                                    <figure class="avatar avatar-40">
                                        <img src="<?php echo base_url() . "templates/"; ?>img/user2.png" alt="Generic placeholder image">
                                    </figure>
                                ...
                                <a href="#" class="media pink-gradient-active new">
                                    <figure class="avatar avatar-40">
                                        <img src="<?php echo base_url() . "templates/"; ?>img/user3.png" alt="Generic placeholder image">
                                    </figure>
                                    <div class="media-body">
                        ...
                        <div class="dropdown d-inline-block">
                            <a class="btn header-color-secondary dropdown-toggle username" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <figure class="userpic"><img src="<?php echo base_url() . "templates/"; ?>img/user1.png" alt=""></figure>
                                    ...
                                    <div class="card-body text-center">
                                        <a href="profile.html">
                                            <figure class="avatar avatar-120 mx-auto my-3">
                                                <img src="<?php echo base_url() . "templates/"; ?>img/user1.png" alt="">
                                            </figure>
